//import 'package:qubilocks_v014_fw/qubilocks_v014_fw.dart';
import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UICampoSeleccionNuevo extends StatefulWidget {
  UICampoSeleccionNuevo({
    this.titulo,
    @required this.data,
    @required this.campo,
    this.etiqueta,
  ...
  @override
  _UICampoSeleccionNuevoState createState() => _UICampoSeleccionNuevoState();
}

class _UICampoSeleccionNuevoState extends State<UICampoSeleccionNuevo> {
...
//            borderRadius: BorderRadius.circular(40),
          ...
          margin: EdgeInsets.only(
            left: (MediaQuery.of(context).size.width - widget.anchoLista) / 4,
            right: (MediaQuery.of(context).size.width - widget.anchoLista) / 4,
            top: (MediaQuery.of(context).size.height - widget.altoLista) / 4,
            bottom: (MediaQuery.of(context).size.height - widget.altoLista) / 4,
          ),
          child: dialog,
        );
      },
