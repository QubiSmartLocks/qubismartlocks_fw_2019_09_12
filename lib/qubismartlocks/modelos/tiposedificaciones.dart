...
class TipoEdificacion {
  ...
  int id;
  String denomTipoEdificacion;
  String descTipoEdificacion;
  bool seZonifica;
  bool tieneMultiplesUnidadesFuncionales;
...
class TIPOSEDIFICACIONES {
  ...
  static const List CAMPOS_LISTADO = [ID,DENOMTIPOEDIFICACION,SEZONIFICA,TIENEMULTIPLESUNIDADESFUNCIONALES,];
  static const List CAMPOS_DETALLE = [ID,DENOMTIPOEDIFICACION,DESCTIPOEDIFICACION,SEZONIFICA,TIENEMULTIPLESUNIDADESFUNCIONALES,];
