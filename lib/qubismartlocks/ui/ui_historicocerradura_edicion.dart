...
// Edicion para [//Históricos de Cerraduras]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UIHistoricoCerraduraEdicion extends StatefulWidget {
  UIHistoricoCerraduraEdicion({Key key, this.registro}) : super(key: key);

  final HistoricoCerradura registro;

  @override
  _EstadoHistoricoCerraduraEdicion createState() =>
      _EstadoHistoricoCerraduraEdicion();
}

class _EstadoHistoricoCerraduraEdicion extends State<UIHistoricoCerraduraEdicion> {
  ...
  String _validarCerradura(Cerradura value) {
    _formaEditada = true;
