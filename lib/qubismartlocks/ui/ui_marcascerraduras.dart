...
class UIMarcasCerraduras extends StatefulWidget {
  UIMarcasCerraduras({Key key}) : super(key: key);
  static const String ruta = '/marcascerraduras';
  final v = Vidget();

  @override
  State createState() => _EstadoMarcasCerraduras();
}

class _EstadoMarcasCerraduras extends State<UIMarcasCerraduras> {
  GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  List<MarcaCerradura> lista = List<MarcaCerradura>();

  Future<Resultado> getMarcasCerraduras() async {
    setState(() {
      widget.v.mensaje = Co.MENSAJE_ESPERA;
    });

    Resultado _resultado = await MarcasCerraduras.todos(lista);
  ...
  Widget build(BuildContext context) {
    widget.v.titulo = MARCASCERRADURAS.ETIQUETA_ENTIDAD;
...
//                                                Container(
//                                                  child:
//                                                  Image.asset(imagenCard),
//                                                ),
                                              CircleAvatar(
                                                backgroundColor: AppRes
                                                    .appResMap[Co.COLOR_2],
                                                backgroundImage:
                                                AssetImage('images/web_cubi_icon_cerraduras.png'),
                                              ),
                                            ),
                                            Container(
