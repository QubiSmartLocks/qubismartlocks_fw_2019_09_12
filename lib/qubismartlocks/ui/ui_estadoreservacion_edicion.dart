...
// Edicion para [//Estados de Reservaciones]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UIEstadoReservacionEdicion extends StatefulWidget {
  UIEstadoReservacionEdicion({Key key, this.registro}) : super(key: key);

  final EstadoReservacion registro;

  @override
  _EstadoEstadoReservacionEdicion createState() =>
      _EstadoEstadoReservacionEdicion();
}

class _EstadoEstadoReservacionEdicion extends State<UIEstadoReservacionEdicion> {
