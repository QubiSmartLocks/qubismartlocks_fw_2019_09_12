...
// Edicion para [//Edificaciones]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UIEdificacionEdicion extends StatefulWidget {
  UIEdificacionEdicion({Key key, this.registro}) : super(key: key);

  final Edificacion registro;

  @override
  _EstadoEdificacionEdicion createState() =>
      _EstadoEdificacionEdicion();
}

class _EstadoEdificacionEdicion extends State<UIEdificacionEdicion> {
  ...
  String _validarTipoEdificacion(TipoEdificacion value) {
    _formaEditada = true;
  ...
  String _validarPropietario(Propietario value) {
    _formaEditada = true;
    // TODO: Falta validar las Claves Foraneas
