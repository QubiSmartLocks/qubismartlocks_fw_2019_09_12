...
class UIRoomEdicion extends StatefulWidget {
  UIRoomEdicion({Key key, this.registro}) : super(key: key);

  final Room registro;

  @override
  _EstadoRoomEdicion createState() =>
      _EstadoRoomEdicion();
}

class _EstadoRoomEdicion extends State<UIRoomEdicion> {
