...
// Edicion para [//Conversaciones]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UIConversacionEdicion extends StatefulWidget {
  UIConversacionEdicion({Key key, this.registro}) : super(key: key);

  final Conversacion registro;

  @override
  _EstadoConversacionEdicion createState() =>
      _EstadoConversacionEdicion();
}

class _EstadoConversacionEdicion extends State<UIConversacionEdicion> {
