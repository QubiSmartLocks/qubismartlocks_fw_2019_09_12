...
// Edicion para [//Zonas en Edificaciones]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UIZonaEdificacionEdicion extends StatefulWidget {
  UIZonaEdificacionEdicion({Key key, this.registro}) : super(key: key);

  final ZonaEdificacion registro;

  @override
  _EstadoZonaEdificacionEdicion createState() =>
      _EstadoZonaEdificacionEdicion();
}

class _EstadoZonaEdificacionEdicion extends State<UIZonaEdificacionEdicion> {
