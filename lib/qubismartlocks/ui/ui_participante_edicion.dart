...
// Edicion para [//Participantes]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UIParticipanteEdicion extends StatefulWidget {
  UIParticipanteEdicion({Key key, this.registro}) : super(key: key);

  final Participante registro;

  @override
  _EstadoParticipanteEdicion createState() =>
      _EstadoParticipanteEdicion();
}

class _EstadoParticipanteEdicion extends State<UIParticipanteEdicion> {
