...
// Edicion para [//Logs de Cerraduras]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UILogCerraduraEdicion extends StatefulWidget {
  UILogCerraduraEdicion({Key key, this.registro}) : super(key: key);

  final LogCerradura registro;

  @override
  _EstadoLogCerraduraEdicion createState() =>
      _EstadoLogCerraduraEdicion();
}

class _EstadoLogCerraduraEdicion extends State<UILogCerraduraEdicion> {
