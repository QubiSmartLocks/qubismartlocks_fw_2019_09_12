...
// Edicion para [//Pasajeros]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class UIPasajeroEdicion extends StatefulWidget {
  UIPasajeroEdicion({Key key, this.registro}) : super(key: key);

  final Pasajero registro;

  @override
  _EstadoPasajeroEdicion createState() =>
      _EstadoPasajeroEdicion();
}

class _EstadoPasajeroEdicion extends State<UIPasajeroEdicion> {
