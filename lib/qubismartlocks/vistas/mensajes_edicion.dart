...
// Edicion para [Mensajería (Chats)/Mensajería (Chats)/Mensajes]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class FMensajesEdicion extends StatefulWidget {
  FMensajesEdicion({Key key, this.registro}) : super(key: key);

  final Mensaje registro;

  @override
  _EstadoMensajesEdicion createState() =>
      _EstadoMensajesEdicion();
}

class _EstadoMensajesEdicion extends State<FMensajesEdicion> {
  ...
  String _validarParticipante(int value) {
    _formaEditada = true;
    // TODO: Falta validar las Claves Foraneas
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          //MENSAJES.ETIQUETA_REGISTRO + Co.TITULO_ABRE +
