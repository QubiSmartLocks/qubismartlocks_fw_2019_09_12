...
class FReservacionesEdicion extends StatefulWidget {
  FReservacionesEdicion({Key key, this.registro}) : super(key: key);

  final Reservacion registro;

  @override
  _EstadoReservacionesEdicion createState() =>
      _EstadoReservacionesEdicion();
}

class _EstadoReservacionesEdicion extends State<FReservacionesEdicion> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          //RESERVACIONES.ETIQUETA_REGISTRO + Co.TITULO_ABRE +
              ((widget.registro.id == null) || (widget.registro.id == 0))
                  ? Co.VISTA_NUEVO_REGISTRO
                  : widget.registro.idEdificacion,
          //    + Co.TITULO_CIERRA,
