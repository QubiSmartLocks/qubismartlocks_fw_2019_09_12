...
class ModeloCerraduraItem extends StatefulWidget {
  ModeloCerraduraItem({
    this.registro,
    this.lista,
    this.animation,
  ...
  final List<ModeloCerradura> lista;
  final ModeloCerradura registro;
  final Animation animation;

  @override
  _ModeloCerraduraItemState createState() => _ModeloCerraduraItemState();
}

class _ModeloCerraduraItemState extends State<ModeloCerraduraItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () async {
          ...
          Resultado _resultado = await  ModelosCerraduras.registro(widget.registro.id, widget.registro);
          ...
          if (_resultado.estado == Co.OK) {
            ...
            ModeloCerradura registroEnEdicion = ModeloCerradura();
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(widget.registro.marca.denomMarcaCerradura,
