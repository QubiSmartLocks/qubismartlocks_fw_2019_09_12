...
class FUnidadesFuncionalesEdicion extends StatefulWidget {
  FUnidadesFuncionalesEdicion({Key key, this.registro}) : super(key: key);
...
class _EstadoUnidadesFuncionalesEdicion extends State<FUnidadesFuncionalesEdicion> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          //UNIDADESFUNCIONALES.ETIQUETA_REGISTRO + Co.TITULO_ABRE +
