...
class TipoEdificacionItem extends StatefulWidget {
  TipoEdificacionItem({
    this.registro,
    this.lista,
    this.animation,
  ...
  final List<TipoEdificacion> lista;
  final TipoEdificacion registro;
  final Animation animation;

  @override
  _TipoEdificacionItemState createState() => _TipoEdificacionItemState();
}

class _TipoEdificacionItemState extends State<TipoEdificacionItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () async {
          ...
          Resultado _resultado = await  TiposEdificaciones.registro(widget.registro.id, widget.registro);
          ...
          if (_resultado.estado == Co.OK) {
            ...
            TipoEdificacion registroEnEdicion = TipoEdificacion();
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(widget.registro.denomTipoEdificacion,
                      style: estiloListados),
                  Text(widget.registro.seZonifica.toString(),
                      style: estiloListados),
                  Text(widget.registro.tieneMultiplesUnidadesFuncionales.toString(),
                      style: estiloListados),
                ],
              )
            ],
