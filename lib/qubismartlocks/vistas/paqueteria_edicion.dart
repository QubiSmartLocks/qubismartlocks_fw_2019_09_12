...
class FPaqueteriaEdicion extends StatefulWidget {
  FPaqueteriaEdicion({Key key, this.registro}) : super(key: key);

  final Paquete registro;

  @override
  _EstadoPaqueteriaEdicion createState() =>
      _EstadoPaqueteriaEdicion();
}

class _EstadoPaqueteriaEdicion extends State<FPaqueteriaEdicion> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          //PAQUETERIA.ETIQUETA_REGISTRO + Co.TITULO_ABRE +
