...
class CerraduraItem extends StatefulWidget {
  CerraduraItem({
    this.registro,
    this.lista,
    this.animation,
  ...
  final List<Cerradura> lista;
  final Cerradura registro;
  final Animation animation;

  @override
  _CerraduraItemState createState() => _CerraduraItemState();
}

class _CerraduraItemState extends State<CerraduraItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () async {
          ...
          Resultado _resultado = await  Cerraduras.registro(widget.registro.id, widget.registro);
          ...
          if (_resultado.estado == Co.OK) {
            ...
            Cerradura registroEnEdicion = Cerradura();
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(widget.registro.denomCerradura,
                      style: estiloListados),
                  Text(widget.registro.modelo.denomModelo,
                      style: estiloListados),
                  Text(widget.registro.unidadFuncional.denomUnidadFuncional,
                      style: estiloListados),
                  Text(widget.registro.estadoCerradura.denomEstadoCerradura,
                      style: estiloListados),
                ],
              )
            ],
