...
class OrigenPaqueteItem extends StatefulWidget {
  OrigenPaqueteItem({
    this.registro,
    this.lista,
    this.animation,
  ...
  final List<OrigenPaquete> lista;
  final OrigenPaquete registro;
  final Animation animation;

  @override
  _OrigenPaqueteItemState createState() => _OrigenPaqueteItemState();
}

class _OrigenPaqueteItemState extends State<OrigenPaqueteItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () async {
          ...
          Resultado _resultado = await  OrigenesPaquetes.registro(widget.registro.id, widget.registro);
          ...
          if (_resultado.estado == Co.OK) {
            ...
            OrigenPaquete registroEnEdicion = OrigenPaquete();
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(widget.registro.denomOrigenPaquete,
