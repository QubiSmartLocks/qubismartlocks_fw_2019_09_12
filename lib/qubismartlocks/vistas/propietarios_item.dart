...
class PropietarioItem extends StatefulWidget {
  PropietarioItem({
    this.registro,
    this.lista,
    this.animation,
  ...
  final List<Propietario> lista;
  final Propietario registro;
  final Animation animation;

  @override
  _PropietarioItemState createState() => _PropietarioItemState();
}

class _PropietarioItemState extends State<PropietarioItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () async {
          ...
          Resultado _resultado = await  Propietarios.registro(widget.registro.id, widget.registro);
          ...
          if (_resultado.estado == Co.OK) {
            ...
            Propietario registroEnEdicion = Propietario();
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(widget.registro.nombreCompletoPropietario,
