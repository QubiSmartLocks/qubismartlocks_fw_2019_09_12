...
// Edicion para [Clock PMS (Api Reservaciones)/Clock PMS (Api Reservaciones)/Bookings]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class FBookingsEdicion extends StatefulWidget {
  FBookingsEdicion({Key key, this.registro}) : super(key: key);

  final Booking registro;

  @override
  _EstadoBookingsEdicion createState() =>
      _EstadoBookingsEdicion();
}

class _EstadoBookingsEdicion extends State<FBookingsEdicion> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          //BOOKINGS.ETIQUETA_REGISTRO + Co.TITULO_ABRE +
