...
class EstadoCerraduraItem extends StatefulWidget {
  EstadoCerraduraItem({
    this.registro,
    this.lista,
    this.animation,
  ...
  final List<EstadoCerradura> lista;
  final EstadoCerradura registro;
  final Animation animation;

  @override
  _EstadoCerraduraItemState createState() => _EstadoCerraduraItemState();
}

class _EstadoCerraduraItemState extends State<EstadoCerraduraItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () async {
          ...
          Resultado _resultado = await  EstadosCerraduras.registro(widget.registro.id, widget.registro);
          ...
          if (_resultado.estado == Co.OK) {
            ...
            EstadoCerradura registroEnEdicion = EstadoCerradura();
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(widget.registro.denomEstadoCerradura,
                      style: estiloListados),
                  Text(widget.registro.activa.toString(),
                      style: estiloListados),
                ],
              )
            ],
