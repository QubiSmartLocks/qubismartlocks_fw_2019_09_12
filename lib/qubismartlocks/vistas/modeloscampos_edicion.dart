...
// Edicion para [Modelos de Campos/Modelos de Campos/Modelos Campos]

import 'package:qubismartlocks_fw/qubismartlocks.dart';


class FModelosCamposEdicion extends StatefulWidget {
  FModelosCamposEdicion({Key key, this.registro}) : super(key: key);

  final ModeloCampo registro;

  @override
  _EstadoModelosCamposEdicion createState() =>
      _EstadoModelosCamposEdicion();
}

class _EstadoModelosCamposEdicion extends State<FModelosCamposEdicion> {
  ...
  String _validarModeloForaneo(int value) {
    _formaEditada = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          //MODELOSCAMPOS.ETIQUETA_REGISTRO + Co.TITULO_ABRE +
              ((widget.registro.id == null) || (widget.registro.id == 0))
                  ? Co.VISTA_NUEVO_REGISTRO
                  : widget.registro.denomModelo,
          //    + Co.TITULO_CIERRA,
