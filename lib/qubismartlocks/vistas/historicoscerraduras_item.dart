...
class HistoricoCerraduraItem extends StatefulWidget {
  HistoricoCerraduraItem({
    this.registro,
    this.lista,
    this.animation,
  });

  final List<HistoricoCerradura> lista;
  final HistoricoCerradura registro;
  final Animation animation;

  @override
  _HistoricoCerraduraItemState createState() => _HistoricoCerraduraItemState();
}

class _HistoricoCerraduraItemState extends State<HistoricoCerraduraItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () async {
          ...
          Resultado _resultado = await  HistoricosCerraduras.registro(widget.registro.id, widget.registro);
          ...
          if (_resultado.estado == Co.OK) {
            ...
            HistoricoCerradura registroEnEdicion = HistoricoCerradura();
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Text(widget.registro.hora.toString(),
                      style: estiloListados),
                  // TODO: Definir el enlace para Id en clave foranea HistoricoCerradura.Usuario
                  Text(widget.registro.usuario.toString(),
                      style: estiloListados),
                  Text(widget.registro.funcion,
                      style: estiloListados),
                ],
              )
            ],
